      ...
      <div className="flex flex-col gap-16">
        <Section>
          ...
          <ul className="list-disc list-inside space-y-2 text-secondary mt-4">
            ...
            <li>Performed data integration for 15 SAP tables into SQL using REST API calls, converting data to XML, parsing values, and executing nightly full loads by truncating and reloading SQL tables.</li>
          </ul>
        </Section>
        ...
        <Section>
          ...
          <p className="text-tertiary">June 2023 - July 2024</p>
          <ul className="list-disc list-inside space-y-2 text-secondary mt-4">
